<template>
  <div>
    <q-layout view="lHh Lpr lFf">
      ...
      <q-page-container>
        <div class="bg-grey-1">
          <div class="text-h2 flex flex-center q-mt-md text-grey-9 text-bold">WELCOME</div>
          <div class="text-h2 flex flex-center q-mt-md text-grey-9 text-bold">ADMINISTRATOR!</div>
          <div class="flex flex-center q-mt-md ">
            <span class="text-subtitle1 text-bold text-grey-9">Address:</span>
            <span class="text-subtitle1 text-grey-9 q-ml-sm">{{ currentAccount}}</span>
            <span class="text-subtitle1 text-bold text-grey-9 q-ml-lg">Eth Balance:</span>
            <span class="text-subtitle1 text-grey-9 q-ml-sm">{{ ethBalance}}</span>
            <span class="text-subtitle1 text-bold text-grey-9 q-ml-lg">Login Time:</span>
            <span class="text-subtitle1 text-grey-9 q-ml-sm">12:00pm</span>
          </div>
        </div>
        ...
        <div class="flex flex-center q-mt-md">
          ...
          <!-- <span class="text-h4 text-green "></span> -->
        </div>
        <router-view />
      </q-page-container>
    </q-layout>
